...
.controller('loginUserController',['loginUserService','$stateParams','$state','$scope','$location',function(loginUserService,$stateParams,$state,$scope,$location){
...
//  userLoginScope.logout = function(){
